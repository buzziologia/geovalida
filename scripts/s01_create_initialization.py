...
Este script é a ETAPA 1 do pipeline GeoValida.
"""
...
# Adicionar raiz do projeto ao path para importação correta
...
def main():
    """Função principal."""
    logger.info("=" * 80)
    logger.info("ETAPA 1: INICIALIZAÇÃO DE DADOS - GeoValida")
    logger.info("=" * 80)
